...
*   **多様なAIモデル対応**: OpenAI GPT-4o、Google Gemini 2.5 Pro、NVIDIA NIM、Mistralなど
*   **継続的な会話:** 返信を続けることで文脈を維持した会話が可能です。
*   **画像認識:** メッセージと一緒に画像を添付すると、AIが画像の内容も理解しようとします (ビジョンモデル対応の場合)。
*   **画像生成:** Stable Diffusion WebUI Forgeを使用した高品質な画像生成
...
*   **多彩なソースに対応:** YouTube, SoundCloud、ニコニコ動画などのURLや検索クエリから音楽を再生・キューに追加できます。
